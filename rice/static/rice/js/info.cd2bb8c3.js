...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"@babel/runtime-corejs2/core-js/promise":"../node_modules/@babel/runtime-corejs2/core-js/promise.js"}],"../node_modules/core-js/library/modules/_object-to-array.js":[function(require,module,exports) {
var DESCRIPTORS = require('./_descriptors');
var getKeys = require('./_object-keys');
var toIObject = require('./_to-iobject');
...
},{"core-js/library/fn/object/entries":"../node_modules/core-js/library/fn/object/entries.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/vega-util/build/vega-util.module.js":[function(require,module,exports) {
"use strict";
...
exports.zero = exports.truthy = exports.one = exports.isArray = exports.identity = exports.id = exports.falsy = exports.ascending = exports.Warn = exports.None = exports.Info = exports.Error = exports.Debug = void 0;
...
},{}],"../node_modules/vega-tooltip/build/vega-tooltip.module.js":[function(require,module,exports) {
"use strict";
...
exports.version = exports.Handler = exports.DEFAULT_OPTIONS = void 0;
...
var _module = "build/vega-tooltip.module.js";
...
},{"vega-util":"../node_modules/vega-util/build/vega-util.module.js"}],"js/config.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/viz.js":[function(require,module,exports) {
"use strict";
...
function viz(x, y) {
  ...
  }).encode(vl.x().fieldN(x).axis({
    labelAngle: 0
  }), vl.y().fieldQ(y), vl.color().fieldN(x), vl.tooltip([vl.fieldQ(y), vl.fieldN(x)]));
  return v;
}
...
var _viz = _interopRequireDefault(require("./viz"));
...
vl.register(vega, vegaLite, {
  ...
  init: function init(view) {
    view.tooltip(new _vegaTooltip.Handler().call);
  }
});

var BarChart = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(el, data, x, y) {
    var marks;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            marks = (0, _viz.default)(x, y).data(data).width(400).height(300).autosize({
              type: 'fit',
              contains: 'padding'
  ...
  return function BarChart(_x, _x2, _x3, _x4) {
...
exports.default = _default;
},{"@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js"}],"js/info.js":[function(require,module,exports) {
"use strict";
...
var btnFroup = document.querySelectorAll('#btn-menu');
var datatest = [{
  'Rice categories': {
    value: "\u0E02\u0E49\u0E32\u0E27\u0E40\u0E1B\u0E25\u0E37\u0E2D\u0E01",
    unit: null
...
function activeMenu() {
  var current = document.querySelector('#btn-menu.active');
...
function creatChart(_x) {
  return _creatChart.apply(this, arguments);
}

function _creatChart() {
  _creatChart = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(el) {
    var data, view;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _getData.default)("/get_data_info/2/".concat(el.dataset.field, "/"));
...
function creatTable(_x2, _x3) {
  return _creatTable.apply(this, arguments);
}

function _creatTable() {
  _creatTable = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(gtable, el) {
    var data, view;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _getData.default)("/get_data_info/".concat(id, "/").concat(el.dataset.field, "/"));
          ...
          case 3:
            ...
            data.forEach(function (item) {
              ...
              t.classList = 'dashboard__table';
              t.createCaption().innerHTML = item['Rice categories'].value;
              var header = t.createTHead();
              var rowHead = header.insertRow(0);
              var cellH1 = rowHead.insertCell(0);
              var cellH2 = rowHead.insertCell(1);
              cellH1.innerHTML = 'fieldNameUIEN';
              cellH2.innerHTML = 'value';
              cellH2.classList = 'text-right';
              var tBody = document.createElement('tbody');
              (0, _entries.default)(item).forEach(function (_ref, index) {
                ...
                cell1.innerHTML = key;
                cell2.innerHTML = "".concat(value.value, " ").concat(value.unit ? value.unit : '');
                cell2.classList = 'text-right';
              });
              t.appendChild(tBody);
              gtable.appendChild(t);
            });
...
function onMenuChange(el) {
  activeMenu();
  el.classList.add('active');
  var view = document.querySelector('#view');
  var tables = document.querySelector('.group-table');
  resetView(view);
  resetView(tables);
  creatTable(tables, el);
}

function addEventClickMenu(nodelist, callback) {
...
addEventClickMenu(btnFroup, onMenuChange);
},{"@babel/runtime-corejs2/helpers/slicedToArray":"../node_modules/@babel/runtime-corejs2/helpers/slicedToArray.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","@babel/runtime-corejs2/core-js/object/entries":"../node_modules/@babel/runtime-corejs2/core-js/object/entries.js","@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","./BarChart":"js/BarChart.js","./getData":"js/getData.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
